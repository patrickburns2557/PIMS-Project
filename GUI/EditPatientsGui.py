...
class PersonalInfoTab(ctk.CTkScrollableFrame):
    def __init__(self, parentWidget, patient):
        ...
        self.addEmergencyNameButton1.configure(command=lambda: self.addEmergencyContact(patient, self.note.get(),1,1))
        ...
        self.addEmergencyPhoneButton1.configure(command=lambda: self.addEmergencyContact(patient, self.note.get(),2,1))
        ...
        self.addEmergencyNameButton2.configure(command=lambda: self.addEmergencyContact(patient, self.note.get(),1,2))
        ...
        self.addEmergencyPhoneButton2.configure(command=lambda: self.addEmergencyContact(patient, self.note.get(),2,2))
        ...
        self.addEmergencyNameButton3.configure(command=lambda: self.addEmergencyContact(patient, self.note.get(),1,3))
        ...
        self.addEmergencyPhoneButton3.configure(command=lambda: self.addEmergencyContact(patient, self.note.get(),2,3))
