...
class MedicalInfoTab(ctk.CTkScrollableFrame, ):
    def __init__(self, parentWidget, patient):
        ...
        self.addNoteFrame.grid(row=3, column=2, sticky="nw", padx=PADSECTION, pady=PADSECTION)
        LabelBorder(self.addNoteFrame, "Admittance Date").grid(row=3, column=0, sticky="w", padx=PADLABEL,
                                                               pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Admittance Time").grid(row=5, column=0, sticky="w", padx=PADLABEL,
                                                               pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Admittance Reason").grid(row=7, column=0, sticky="w", padx=PADLABEL,
                                                                 pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Discharge Date").grid(row=10, column=0, sticky="w", padx=PADLABEL,
                                                              pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Discharge Time").grid(row=13, column=0, sticky="w", padx=PADLABEL,
                                                              pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Prescription Medicine Name").grid(row=1, column=3, sticky="w", padx=PADLABEL,
                                                                          pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Prescriptions Amount").grid(row=4, column=3, sticky="w", padx=PADLABEL,
                                                                    pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Prescriptions Schedule").grid(row=7, column=3, sticky="w", padx=PADLABEL,
                                                                      pady=PADLABEL)
        ...
        LabelBorder(self.addNoteFrame, "Scheduled Procedures ").grid(row=10, column=3, sticky="w", padx=PADLABEL,
                                                                     pady=PADLABEL)
...
class BillingInfoTab(ctk.CTkScrollableFrame):
    def __init__(self, parentWidget, patient):
        ...
        LabelBorder(self.addNoteFrame, "Amount paid by Insurance").grid(row=10, column=4, sticky="w", padx=PADLABEL,
                                                                        pady=PADLABEL)
    ...
    def addChargeRefresh(self, patient):
        ...
        LabelBorder(self.chargesNoteFrame, "Charges and Amounts").grid(row=0, column=0, sticky="w", padx=PADLABEL,
                                                                       pady=PADLABEL)
